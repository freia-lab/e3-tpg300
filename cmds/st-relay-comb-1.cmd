...
#- Configuration: Sensor A1 no relay, Sensor A2 Relay1 and Relay2, Sensor B1 Relay 3 and Relay4, Sensor B2 no relays

iocshLoad(${tpg300_DIR}/_vac_gauge_tpg300_vgc_no_relays_freia.iocsh, "DEVICENAME = CH-A1, CHANNEL = A1, SOURCE = A,  CONTROLLERNAME = TPG300-8, BOARD = PE, GAUGE = IKR50")
iocshLoad(${tpg300_DIR}/_vac_gauge_tpg300_vgc_freia.iocsh, "DEVICENAME = CH-A2, CHANNEL = A2, SOURCE = B,  CONTROLLERNAME = TPG300-8, BOARD = PE, GAUGE = TPR18, RELAY1_SOURCE = A, RELAY1 = 1, RELAY2_SOURCE = B, RELAY2 = 2")
