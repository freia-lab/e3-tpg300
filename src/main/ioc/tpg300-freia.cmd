...
epicsEnvSet("PREFIX-7", "TPG300-7")
epicsEnvSet("PREFIX-8", "TPG300-8")
...
epicsEnvSet("TPG_ADDR-7", "192.168.10.7:4016")
epicsEnvSet("TPG_PORT-7", "TPG-7")
epicsEnvSet("TPG_ADDR-8", "192.168.10.7:4015")
epicsEnvSet("TPG_PORT-8", "TPG-8")
...
drvAsynIPPortConfigure(${TPG_PORT-7}, ${TPG_ADDR-7})
drvAsynIPPortConfigure(${TPG_PORT-8}, ${TPG_ADDR-8})
...
tpg300InterposeConfig(${TPG_PORT-7})
tpg300InterposeConfig(${TPG_PORT-8})
...
dbLoadRecords("tpg300.db", "PREFIX=${PREFIX-7},TPG_PORT=${TPG_PORT-7},SCAN_RATE=${TPG_SCAN}")
dbLoadRecords("tpg300.db", "PREFIX=${PREFIX-8},TPG_PORT=${TPG_PORT-8},SCAN_RATE=${TPG_SCAN}")
